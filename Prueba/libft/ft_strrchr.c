...
/*   Updated: 2024/08/07 12:33:21 by rbuitrag         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	if (resstr != NULL)
	{
		printf("Funcion strrchr esta en posicion: %ld. \n", (resstr-src));
	} else
			printf("Funcion strrchr NO esta: %c\n", c);
	if (ftstr != NULL)
	{
		printf("Funcion FT_strrchr esta en posicion: %ld. \n", (ftstr-src));
	} else
